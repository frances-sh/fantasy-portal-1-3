...
export async function Header() {
  ...
  return (
    <header className="flex flex-col gap-4 border-b border-white/6 px-6 py-5 md:flex-row md:items-center md:justify-between">
      <div>
        <p className="text-xs uppercase tracking-[0.35em] text-cyan-200/60">Arquivo narrativo e social</p>
        <h1 className="fantasy-title mt-2 text-2xl font-black text-white md:text-4xl">Portal de Universos</h1>
      </div>
